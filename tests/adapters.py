...
from cs336_basics.nn_modules import Linear, Embedding, RMSNorm, SiLU,\
    SwiGLU, RotaryPositionalEmbedding, softmax, scaled_dot_product_attention, \
    MultiheadSelfAttention, TransformerBlock, TransformerLM
from cs336_basics.optimizer import AdamW
from cs336_basics.loss import cross_entropy as _cross_entropy
from cs336_basics.scheduler import cosine_annealing_with_linear_warmup
from cs336_basics.dataloader import get_batch
from cs336_basics.clipping import gradient_clipping
...
def run_get_lr_cosine_schedule(
    ...
    return cosine_annealing_with_linear_warmup(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
